...
__The Pipeline of EHGCN: Hierarchical Euclidean-Hyperbolic Fusion via Motion-Aware GCN for Hybrid Event Stream Perception__
![result](Pics/2.png)
...
__Event camera data exhibit strong anisotropy in spatio-temporal distribution:__
![result](Pics/1.png)
...
__Visual comparison of events after sampling on the N-Caltech101 dataset.__
![result](Pics/6.png)
...
__Object detection visualization on the Gen1 dataset.__ 
![result](Pics/5.png)
